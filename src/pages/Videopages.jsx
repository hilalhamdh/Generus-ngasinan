      ...
      <div className="videopages pt-20 bg-gradient-to-r from-rose-100 to-sky-300 to-90%">
        <div className="Container mx-auto  py-5 items-center justify-items-center">
          ...
          <div className=" pt-1 grid md:grid-cols-2 grid-cols-1  justify-content-center items-center md:gap-2 gap-1  ">
            ...
            <div className=" flex box items-center justify-items-center  bg-white h-[355px] w-[390] md:w-[650px] px-2 pb-4 ">
              <ReactPlayer
            ...
            <div className="flex box items-center justify-items-center  bg-white h-[355px] w-[390] md:w-[650px] px-2 pb-4 rounded-sm ">
              <ReactPlayer
